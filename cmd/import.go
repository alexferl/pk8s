...
func example() string {
	...
	fmt.Fprintln(w, "pk8s import crd-certificates.yaml\tImports CRDs from a file")
	fmt.Fprintln(w, "pk8s import my_name:=crd-certificates.yaml\tImports CRDs from a file using a custom package name")
